...
Future<List<Map<String, dynamic>>> getPdfList() async {
  ...
  return db.collection("Verbal Ability").get().then(
    (querySnapshot) {
...
class VerbalAbility extends StatefulWidget {
  const VerbalAbility({super.key});

  @override
  State<VerbalAbility> createState() => _quantsState();
}

class _quantsState extends State<VerbalAbility> {
